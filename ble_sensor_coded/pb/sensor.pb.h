...
#define SensorMessage_init_default               {0, {TemperatureReading_init_default, TemperatureReading_init_default, TemperatureReading_init_default}, MJReading_init_default}
#define TemperatureReading_init_default          {0, {0}}
#define MJReading_init_default                   {0, 0, 0}
#define CentralMessage_init_zero                 {0, {0}}
#define SensorMessage_init_zero                  {0, {TemperatureReading_init_zero, TemperatureReading_init_zero, TemperatureReading_init_zero}, MJReading_init_zero}
