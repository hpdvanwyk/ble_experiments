...
#define SensorMessage_init_default               {0, {Reading_init_default, Reading_init_default, Reading_init_default, Reading_init_default}, false, CentralMessage_init_default, 0, 0}
#define Reading_init_default                     {{0, {0}}, 0, 0, 0}
#define CentralMessage_init_zero                 {0, {0}}
#define SensorMessage_init_zero                  {0, {Reading_init_zero, Reading_init_zero, Reading_init_zero, Reading_init_zero}, false, CentralMessage_init_zero, 0, 0}
#define Reading_init_zero                        {{0, {0}}, 0, 0, 0}
...
extern const pb_field_t Reading_fields[5];

/* Maximum encoded size of messages (where known) */
#define CentralMessage_size                      14
#define SensorMessage_size                       185
#define Reading_size                             36
