...
#define SensorMessage_init_default               {0, {Reading_init_default, Reading_init_default, Reading_init_default, Reading_init_default}, false, CentralMessage_init_default, 0}
#define Reading_init_default                     {{0, {0}}, 0, 0, 0}
#define CentralMessage_init_zero                 {0, {0}}
#define SensorMessage_init_zero                  {0, {Reading_init_zero, Reading_init_zero, Reading_init_zero, Reading_init_zero}, false, CentralMessage_init_zero, 0}
